...
public class GridItemAdapter extends ArrayAdapter<GridItem> {
  ...
  public GridItemAdapter(Context context, int textViewResourceId, List<GridItem> objects) {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    Glide.with(getContext())
            .load(gridItem.getGrid_view_item_picture())
            .asBitmap()
    ...
    viewHolder.grid_view_item_tag.setText(gridItem.getGrid_view_item_tag());
    return view;
  }
